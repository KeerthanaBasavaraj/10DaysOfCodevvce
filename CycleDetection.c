...
bool has_cycle(SinglyLinkedListNode* head) {
    ...
    SinglyLinkedListNode* one_step;
    SinglyLinkedListNode* two_step;
    one_step = head;
    two_step = head;

    while(two_step != NULL && two_step->next != NULL){
        one_step = one_step->next;        //one_step moves one node forward
        two_step = two_step->next->next;  //two_step moves two nodes forward
